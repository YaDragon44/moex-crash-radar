...
def score(signal: dict, candles: list[dict]) -> dict | None:
    ...
    for name, n in HORIZONS.items():
        ...
        result["horizons"][name] = {
            "forward_return": sample[-1]["c"] / entry - 1,
