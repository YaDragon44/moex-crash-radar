// Investor Radar R1.8.6 — Integrated Risk Gate
// FACT metrics != model score != investment decision. Sanctions risk is explicit and never equals thesis destruction by itself.
(function(global){
'use strict';
...
function assess(candles,liquidity,issuer,regulatory){
 ...
 const sanctionsCritical=regulatoryVerified&&regulatory?.critical===true;
